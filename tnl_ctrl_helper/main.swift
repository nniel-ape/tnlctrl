...
final class HelperDelegate: NSObject, NSXPCListenerDelegate {
    ...
    func listener(_ listener: NSXPCListener, shouldAcceptNewConnection newConnection: NSXPCConnection) -> Bool {
        NSLog("tnl_ctrl_helper: New XPC connection from PID \(newConnection.processIdentifier)")
        ...
        newConnection.invalidationHandler = { [weak self, weak newConnection] in
            NSLog("tnl_ctrl_helper: Connection invalidated")
        ...
        newConnection.interruptionHandler = {
            NSLog("tnl_ctrl_helper: Connection interrupted")
        }
...
NSLog("tnl_ctrl_helper: Starting...")
...
NSLog("tnl_ctrl_helper: Listening on \(helperMachServiceName)")
