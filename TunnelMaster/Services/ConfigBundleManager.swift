...
private let logger = Logger(subsystem: "nniel.TunnelMaster", category: "ConfigBundleManager")
...
final class ConfigBundleManager {
    ...
    func exportConfig() async throws {
        ...
        panel.allowedContentTypes = [.tunnelMasterConfig]
        panel.nameFieldStringValue = "TunnelMaster-Backup"
...
enum ConfigBundleError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case let .unsupportedVersion(version):
            "This file was created with a newer version of TunnelMaster (format v\(version)). Please update the app."
        }
    }
}
